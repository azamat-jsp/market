...
class SearchableModelTest extends TestCase
{
    public function test_successfully_index(): void
    {
        ...
        $user->givePermissionTo(Permission::VIEW_SEARCHABLE_MODEL->value);
    ...
    public function test_successfully_show(): void
    {
         ...
         */
        $user = User::query()->first();
        $user->givePermissionTo(Permission::SHOW_SEARCHABLE_MODEL->value);
    ...
    public function test_successfully_update(): void
    {
         ...
         */
        $user = User::query()->first();
        $user->givePermissionTo(Permission::UPDATE_SEARCHABLE_MODEL->value);
    ...
    public function test_successfully_destroy(): void
    {
         ...
         */
        $user = User::query()->first();
        $user->givePermissionTo(Permission::DELETE_SEARCHABLE_MODEL->value);
