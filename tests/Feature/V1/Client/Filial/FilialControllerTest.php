...
namespace Tests\Feature\V1\Client\Filial;
...
class FilialControllerTest extends TestCase
{
    ...
    public function test_index()
    {
        ...
        $user->givePermissionTo([
            Permission::VIEW_COMPANY_FILIAL->value,
            CompanyPermission::VIEW_COMPANY->value
        ]);

        $company = Company::query()->inRandomOrder()->whereHas('filials')->first();

        $this->actingAs($user)->getJson(route('api.v1.client.company.filial.index', $company->id))
            ->assertSuccessful()
            ->assertJsonStructure([
                'data' => [
                    [
    ...
    public function test_successfully_create_new_filial(): void
    {
        ...
        $user->givePermissionTo([
            Permission::VIEW_COMPANY_FILIAL->value,
            Permission::CREATE_COMPANY_FILIAL->value,
            CompanyPermission::VIEW_COMPANY->value
        ]);
    ...
    public function test_successfully_update_filial(): void
    {
        ...
        $user->givePermissionTo([
            Permission::VIEW_COMPANY_FILIAL->value,
            Permission::UPDATE_COMPANY_FILIAL->value,
            CompanyPermission::VIEW_COMPANY->value
        ]);
    ...
    public function test_successfully_delete_filial()
    {
        ...
        $user->givePermissionTo([
            Permission::VIEW_COMPANY_FILIAL->value,
            Permission::DELETE_COMPANY_FILIAL->value,
            CompanyPermission::VIEW_COMPANY->value
        ]);
