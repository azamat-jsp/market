...
use App\Tbuy\Filial\Filters\CompanyFilter;
use App\Tbuy\Filial\Filters\DateFilter;
...
{
    use HasFactory, HasAllTranslations, SoftDeletes, FilterTrait;
