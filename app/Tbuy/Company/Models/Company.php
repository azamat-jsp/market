...
use App\Tbuy\Company\Filters\IsRejectedFilter;
 ...
 * @property Carbon $domain_updated_at
 ...
 * @property-read Collection<Media> $identityImages
...
class Company extends Model implements HasMedia, Rejectionable, SearchRatingableContract, SearchableContract
{
     ...
     * @return MorphMany
     */
    public function identityImages(): MorphMany
    {
        return $this->morphMany(Media::class, 'model')
            ->where('collection_name', '=', MediaLibraryCollection::COMPANY_IDENTITY);
    }
    ...
    /**
     * @relationMorphColumn socialable
     */
