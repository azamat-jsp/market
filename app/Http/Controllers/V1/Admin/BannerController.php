...
class BannerController extends Controller
{
     ...
     * @bodyParam file file required Файл исходник для сохранения. Макс 50мб
     ...
     * Просмотр
     *
     * @urlParam id int required ID баннера. Example: 1
     *
     ...
     * @bodyParam name.hy string required Название баннера на армянском. Example: banner-hy
     * @bodyParam content object required Контент
     * @bodyParam file file required PSD файл для сохранения. Макс 50мб
