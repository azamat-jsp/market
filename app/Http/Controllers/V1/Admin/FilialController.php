...
use App\Tbuy\Filial\Requests\FilialFilterRequest;
...
class FilialController extends Controller
{
     ...
     * Список филиалов
     *
     * @responseFile storage/responses/filial/paginate.json
     * @queryParam company_id int ID компании. Example: 1
     * @queryParam from string required when to is present фильтр по дате. Example: 2023-08-21
     * @queryParam to string required when from is present фильтр по дате. Example: 2023-08-23
     * @param FilialFilterRequest $request
     * @return SuccessResponse
     */
    public function index(FilialFilterRequest $request): SuccessResponse
    {
        $filials = $this->filialService->getWithoutCompany($request->toDto());
    ...
    /**
     * Список филиалов определенного компании
     *
     ...
     * @return SuccessResponse
     */
    public function byCompany(Company $company): SuccessResponse
    {
     ...
     *
     * @urlParam company_id int required ID компании. Example: 1
     * @urlParam filial_id int required ID филиала. Example: 1
     * @bodyParam name object required Список названий на разных языках
     * @bodyParam name.en string required Название на английском. Example: Name en
     * @bodyParam name.hy string required Название на армянском. Example: Name hy
     * @bodyParam name.ru string required Название на русском. Example: Name ru
