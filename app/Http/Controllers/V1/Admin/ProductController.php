...
use App\Tbuy\Product\Requests\StoreRequest;
...
class ProductController extends Controller
{
     ...
     * Создание продукта
     *
     * @bodyParam name.ru string required Заголовок на русском. Example: some-title
     * @bodyParam name.en string required Заголовок на английском. Example: some-title
     * @bodyParam name.hy string required Заголовок на армянском. Example: some-title
     * @bodyParam images array Список с изображениям продукта
     * @bodyParam images.0 object required Объект с изображениям продукта
     * @bodyParam images.0.name string required Название фотографии продукта. Example:photo-name.jpg
     * @bodyParam images.0.file file required Файл изображения продукта
     ...
     * @bodyParam description.ru string required Описание на русском. Example: some-description
     * @bodyParam description.en string required Описание на английском. Example: some-description
     * @bodyParam description.hy string required Описание на армянском. Example: some-description
     ...
     * @responseFile status=201 storage/responses/product/store.json
     * @param StoreRequest $request
     * @return SuccessResponse
     */
    public function store(StoreRequest $request): SuccessResponse
    {
        $product = $this->productService->store($request->toDto());
     ...
     *
     * @urlParam id integer required ID продукта. Example: 1
     ...
     * <b>waiting</b> - в ожидании <br/>
     * <b>need_update</b> - в ожидании <br/>
