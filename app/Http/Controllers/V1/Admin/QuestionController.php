...
class QuestionController extends Controller
{
     ...
     * @bodyParam question.hy string required Вопрос на армянском языке. Example: Որն է քո սիրելի գույնը
     ...
     * @bodyParam answer.hy string required Ответ на армянском языке. Example: Կապույտ.
