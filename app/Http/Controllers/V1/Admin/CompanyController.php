...
use App\Tbuy\Company\Resources\CompanyDocumentResource;
use App\Tbuy\Company\Resources\CompanyFullResource;
use App\Tbuy\Company\Resources\CompanyInfoResource;
...
class CompanyController extends Controller
{
     ...
     *
     * @urlParam id integer required ID компании. Example: 1
     ...
     * @return SuccessResponse
     */
    public function getEmployees(Company $company): SuccessResponse
    {
     ...
     * @responseFile status=422 scenario="Validation failed" storage/responses/company/get-documents.json
     * @param Company $company
     * @return SuccessResponse
     */
    public function getDocuments(Company $company): SuccessResponse
    {
        return new SuccessResponse(
            response: CompanyDocumentResource::collection($this->companyService->getDocuments($company)),
